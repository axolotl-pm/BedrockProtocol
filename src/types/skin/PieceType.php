...
enum PieceType : string{
	...
	case HANDS = "persona_hands";
	case OUTERWEAR = "persona_outerwear";
	case FACIAL_HAIR = "persona_facialhair";
	case MOUTH = "persona_mouth";
	case EYES = "persona_eyes";
	case HAIR = "persona_hair";
	case HOOD = "persona_hood";
	case BACK = "persona_back";
	case FACE_ACCESSORY = "persona_faceaccessory";
	case HEAD = "persona_head";
	case LEGS = "persona_legs";
	case LEFT_LEG = "persona_leftleg";
	case RIGHT_LEG = "persona_rightleg";
	case ARMS = "persona_arms";
	case LEFT_ARM = "persona_leftarm";
	case RIGHT_ARM = "persona_rightarm";
	case CAPES = "persona_capes";
	case CLASSIC_SKIN = "persona_classicskin";
